...
<script type="text/javascript" src="./resource/js/system/keke.js"></script>
 ...
 <div class="page_title">
        ...
        <div class="tool">
            ...
            <a href="index.php?do=article&view=edit&type=help" class="here" >帮助添加</a>
    	</div>
</div>
<!--页头结束-->    
...
if(json.status==1){ 
 ...
 $("#hdn_art_pic").val("");
                      ...
                      <tr>
                        ...
                        <td>
                         <textarea rows="30" name="fields[content]" style="width:75%;" id="tar_content"  class="xheditor {urlBase:'http://127.0.0.1/weike/',tools:'simple',admin:'./',html5Upload:false,emotMark:false,upImgUrl:'./index.php?do=ajax&view=upload&file_type=att'}" cols="70"></textarea>
</td>
 </tr>
                     <tr>
