...
<div class="page_title">
    	<h1>规则管理</h1>
     	<div class="tool"> 
        <a href="index.php?r=userguanli/xygz">信誉规则管理</a>
        <a href="index.php?r=userguanli/xygzadd" class="here">增加信誉规则</a>
</div>
    </div>
<div class="box post">
        <div class="tabcon">
            ...
            <div class="detail">
               <form action="index.php?r=userguanli/xygzadding" method="post" name="frm1" id="frm1" enctype="multipart/form-data">
