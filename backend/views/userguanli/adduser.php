...
<div class="page_title">
    	<h1>用户管理</h1>
        <div class="tool">
            <a href="index.php?r=userguanli/yhgl" >用户管理</a>
            <a href="index.php?r=userguanli/index" class="here">添加用户</a>
...
<div class="box post">
        <div class="tabcon">
            ...
            <div class="detail">
               <form action="index.php?r=userguanli/useradd" method="post" name="frm_add" id="frm_add">
