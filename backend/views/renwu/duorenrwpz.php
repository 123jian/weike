...
<div class="detail">
 <form action="index.php?r=renwu/updurpz" method="post">
 	<input type="hidden" name="fds[model_id]" value="<?php echo $arr[0]['model_id']?>">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
   <th scope="row" width="200">模型名称：</th>
    <td>
       <input type="text" class="txt" name="fds[model_name]" value="<?php echo $arr[0]['model_name']?>">
</td>
        </tr>
<tr>
   <th scope="row" width="200">是否开启：</th>
     <td>
        <label for="status_yes"><input type="radio" id="status_yes" name="fds[model_status]" <?php if($arr[0]['model_status']==1){ echo "checked";}?> value="1"> 是</label>
<label for="status_no"><input type="radio" id="status_no" name="fds[model_status]" <?php if($arr[0]['model_status']==0){ echo "checked";}?>  value="0"> 否</label>
</td>
        </tr>
<tr>
...
<!-- <tr>
 ...
 <tr>
    <th scope="row" width="200">模型说明：</th>
      <td>
       <textarea cols=110 rows=12 name="fds[model_desc]"  style="width:75%;" id="tar_content"  class="xheditor {urlBase:'http://localhost/weike/',tools:'simple',skin:'nostyle',admin:'../../',html5Upload:false,upImgUrl:'../../index.php?do=ajax&view=upload&file_type=att'}" cols="70"><?php echo $arr[0]['model_desc']?></textarea>
  </td>
         </tr>
  <tr>
