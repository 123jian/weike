...
<div class="case_con clearfix">
    ...
    <a  href="index.php?r=case/select&sid=<?php echo $v['case_id']?>"  ><img src="<?php echo $v['case_img']?>" 
...
<a  href="index.php?do=service&sid=3" class="case_name" title="【创意】著作权（版权）登记"><span class="font14 cc00 mr_5">￥<?php echo $v['case_price']?>元</span>【创意】著作权（版权）登记</a>
</div>
